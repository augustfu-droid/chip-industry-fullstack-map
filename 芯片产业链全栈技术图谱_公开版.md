...
> 版本 v1.7-public · 2026-06-14
> 公开版：仅技术与产业格局视角，不含股票代码、仓位建议与证券推荐
>
> v1.7 更新：彻底清洗投资语言（证券标的→产业参与者 / 仓位→关注优先级 / 目标价→估值敏感变量等）；第 38 章重写为「产业研究方法论与跟踪框架」；附录 C 重写为「半导体产业链代表环节与公开观察对象」；新增执行摘要前置（科普向）；新增附录 H 关键事实与信源说明（20 条）；韬定律段落补强一手来源（华为官方 + CGTN + 新浪财经多源交叉）；统一封面与正文版本号；替换公开版免责声明
>
> v1.6 更新：新增 13 张数据可视化图表，覆盖国产化雷达图、制程演进时间线、EUV 光刻路线、全球代工份额、先进封装家族象限、HBM 代际演进、AI 训练芯片格局气泡图、代工型 CSP 自研 ASIC 甘特图、国产化率分环节柱状图、估值周期阶段图、AI Capex 资金流向图等；落实文中此前承诺但缺失的“图 1.5 国产化进度雷达图”；全部图表使用中文标注（Noto Sans SC 字体），200dpi 高清，与正文统一财经配色
