...
> 版本 v1.12-public · 初版 2026-06-13 · 维护 2026-08-27
...
### 本次维护快照（截至 2026-08-27）

| 层级 | 已核实更新 | 应如何使用 |
|---|---|---|
| **事实 F** | NVIDIA 披露 FY2027 Q2 收入 962.21 亿美元、数据中心收入 890 亿美元，并称 Vera Rubin 已进入全量生产、合作伙伴已有机架运行 [F-82] [G-25]；TSMC N2 已于 2025 年第四季度进入量产 [F-66]；三家存储厂商均已披露 HBM4 量产或高量出货 [F-72] [F-74] [F-75]；四家云厂商最新 2026 公司级资本开支指引机械合计约 7,200–7,450 亿美元 [G-11] [G-12] [G-16] [G-23] | “全量生产”、合作伙伴机架运行、商业出货、客户验收和分产品收入仍是不同证据层级；Capex 也不能直接等同于 AI 支出或半导体收入，Microsoft 的报告口径还受租赁分类变化影响 |
| **判断 J** | 2026 年产业主线已从“有没有技术路线”转向“能否按期认证、量产并转化为现金流”；Rubin 的证据已由路线图推进至公司自报量产，但 HBM、先进封装、电力与网络瓶颈仍会在季度间迁移 | 同时跟踪客户验收、良率、库存、应收、在建工程、折旧和自由现金流，不以单一发布会、供应商措辞或总 Capex 作结论 |
| **复核点** | Rubin 的客户验收、出货量与收入贡献，Groq 3 LPX 的实际云服务可用性，Intel Hot Chips 新架构的投产/供货，High-NA 客户插入、HBM4E 资格认证、BIS 许可证实践 | 每季用公司财报、监管文件、产品可用性和标准组织原文更新；旧路线图若无新证据，降级为公司目标或研究假设 |
...
#### B.1　制造（先进逻辑制程）证据状态表（截至 2026-08-27）
...
> **口径声明（截至 2026-08-27）**：本附录是研究方法，不是证券推荐。「事实」必须有可追溯来源与期间；「假设」必须可修改；「判断」必须写出证伪条件。估值倍数、产能时滞、BOM 占比与库存阈值都不是跨公司通用常数，不再使用无期间、无样本的「经验区间」作结论。
...
4. H-12 至 H-14 建议每季度复核产品、独立测试与论文评审状态；H-21 至 H-29 随季度财报、客户认证、云服务状态、研发设施落地和 BIS 新规滚动复核。
