...
> 版本 v1.11-public · 初版 2026-06-13 · 维护 2026-08-14
...
### 本次维护快照（截至 2026-08-14）

| 层级 | 已核实更新 | 应如何使用 |
|---|---|---|
| **事实 F** | TSMC N2 已于 2025 年第四季度进入量产 [F-66]；Samsung、SK hynix 与 Micron 均已披露 HBM4 量产或高量出货，Samsung 与 SK hynix 已送出 12 层 48GB HBM4E 样品 [F-68] [F-72]–[F-75]；四家云厂商最新 2026 公司级资本开支指引机械合计约 7,200–7,450 亿美元 [G-11] [G-12] [G-16] [G-23] | 只代表逐家公司、逐产品的披露状态；送样、量产体系、商业出货与客户资格认证不可互相替代，Capex 也不能直接等同于 AI 支出或半导体收入；Microsoft 的报告口径还受租赁分类变化影响 |
...
#### B.1　制造（先进逻辑制程）证据状态表（截至 2026-08-14）
...
|---|---|---|---|
| NVIDIA | Blackwell 平台已进入交付；后续产品按官方路线图跟踪 [F-26] | Rubin 等后续平台的日期与规格属于公司目标 | 不预设客户、季度 HVM、供应规模或利润贡献 |
| AMD | MI300/MI325 已公开，MI350 系列按公司材料推进 [F-27] | 后续架构与产品窗口按最新官方路线图更新 | 统一精度、系统层级、软件版本与可供货状态 |
| Intel | Gaudi 3 已发布；Falcon Shores 仅作内部测试芯片，不再作为商业产品 [F-76] | 资源转向 Jaguar Shores，尚无足以写入的 HVM 日期 | “取消商业化”是路线变化，不等于新产品已兑现 |
...
> **口径声明（截至 2026-08-14）**：本附录是研究方法，不是证券推荐。「事实」必须有可追溯来源与期间；「假设」必须可修改；「判断」必须写出证伪条件。估值倍数、产能时滞、BOM 占比与库存阈值都不是跨公司通用常数，不再使用无期间、无样本的「经验区间」作结论。
...
4. H-12 至 H-14 建议每季度复核产品、独立测试与论文评审状态；H-21 至 H-26 随季度财报、客户认证、云服务状态和 BIS 新规滚动复核。
